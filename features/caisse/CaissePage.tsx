...
import { useCaisseJournal, useCaisseSummary } from "./caisse.hooks";
...
export default function CaissePage() {
  ...
  const { summary, loading: summaryLoading, error: summaryError } = useCaisseSummary(date);
  const { entries, total, totalPages, loading: entriesLoading, error: entriesError } = useCaisseJournal(date, page);
