...
export default function ForgotPasswordPage() {
  ...
  async function onCheckPhone(e: FormEvent) {
    ...
    setSubmitting(true);
    try {
      const res = await api.post<{ shop_name: string }>("/auth/forgot-password/check", { phone: phone.trim() });
  ...
  async function onReset(e: FormEvent) {
    ...
    setSubmitting(true);
    try {
      await api.post("/auth/forgot-password/reset", { phone: phone.trim(), new_password: newPassword });
      setStep("done");
    } catch (err) {
